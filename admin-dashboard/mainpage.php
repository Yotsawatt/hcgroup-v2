    ...
    <div class="main-content">
        ...
        <div class="paragraph-section">
            <div class="header-section">
                ...
                <a href="" class="btn green">Add paragraph</a>
            </div>
            <table class="table">
                <tr>
                    <th width="5%">#</th>
        ...
        <div class="picture-section">
            <div class="header-section">
                ...
                <a href="" class="btn green">Add picture</a>
            </div>
            <table class="table">
                <tr>
                    <th width="5%">#</th>
                ...
                <tr>
                    <td>1</td>
                    <td>1</td>
                    <td width="30%"><img src="https://images.unsplash.com/photo-1578509725196-53444c549731?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1055&q=80" alt=""></td>
